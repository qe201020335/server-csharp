...
public record SptProfile
{
    ...
    public UserBuilds? UserBuildData
    {
        get;
        set;
    }
    ...
    public Dictionary<string, Dialogue>? DialogueRecords
    {
        get;
        set;
    }
...
public record UserBuilds
{
    ...
    public List<MagazineBuild>? MagazineBuilds
    {
        get;
        set;
    }
...
public record Dialogue
{
    ...
    public List<UserDialogInfo>? Users
    {
        get;
        set;
    }
...
public record AcceptedCultistReward
{
    ...
    public List<string>? SacrificeItems
    {
        get;
        set;
    }
...
public record ReceivedGift
{
    ...
    public long? TimestampLastAccepted
    {
        get;
        set;
    }
...
public record Vitality
{
    ...
    public Dictionary<string, BodyPartHealth>? Health
    {
        get;
        set;
    }
