...
public record Props
{
    ...
    public List<string>? AllowSpawnOnLocations
    {
        get;
        set;
    }
    ...
    public double? BeltMagazineRefreshCount
    {
        get;
        set;
    }
    ...
    public bool? IsLockedAfterEquip
    {
        get;
        set;
    }
    ...
    public double? QuestStashMaxCount
    {
        get;
        set;
    }
    ...
    public string? MetascoreGroup
    {
        get
        {
            return _metascoreGroup;
        }
        set
        {
            _metascoreGroup = value == null ? null : string.Intern(value);
        }
    }

    [JsonPropertyName("NpcCompressorSendLevel")]
    public double? NpcCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? ObservedPlayerCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public string? UnlootableFromSlot
    {
        get
        {
            return _unlootableFromSlot;
        }
        set
        {
            _unlootableFromSlot = value == null ? null : string.Intern(value);
        }
    }

    [JsonPropertyName("UnlootableFromSide")]
    public List<PlayerSideMask>? UnlootableFromSide
    {
        get;
        set;
    }
    ...
    public ItemDropSoundType? DropSoundType
    {
        get;
        set;
    }
    ...
    public double? RagFairCommissionModifier
    {
        get;
        set;
    }
    ...
    public string? RarityPvE
    {
        ...
        set
        {
            _rarityPvE = value == null ? null : string.Intern(value);
        }
    }
    ...
    public List<EquipmentSlots>? CantRemoveFromSlotsDuringRaid
    {
        get;
        set;
    }
    ...
    public WeaponRecoilSettings? WeaponRecoilSettings
    {
        get;
        set;
    }
    ...
    public double? UniqueAnimationModID
    {
        get;
        set;
    }
    ...
    public double? DoubleActionAccuracyPenaltyMult
    {
        get;
        set;
    }
    ...
    public double? DurabilityBurnModificator
    {
        get;
        set;
    }
    ...
    public List<double>? OpticCalibrationDistances
    {
        get;
        set;
    }
    ...
    public List<List<double>>? CalibrationDistances
    {
        get;
        set;
    }
    ...
    public double? MainTexColorCoef
    {
        get;
        set;
    }
    ...
    public double? MinimumTemperatureValue
    {
        get;
        set;
    }
    ...
    public double? PixelationBlockCount
    {
        get;
        set;
    }
    ...
    public double? MagAnimationIndex
    {
        get;
        set;
    }
    ...
    public double? LoadUnloadModifier
    {
        get;
        set;
    }
    ...
    public double? CheckTimeModifier
    {
        get;
        set;
    }
    ...
    public ReloadMode? ReloadMagType
    {
        get;
        set;
    }
    ...
    public double? MalfunctionChance
    {
        get;
        set;
    }
    ...
    public double? SpeedPenaltyPercent
    {
        get;
        set;
    }
    ...
    public double? ContainerSpawnChanceModifier
    {
        get;
        set;
    }
    ...
    public List<object>? SpawnFilter
    {
        get;
        set;
    } // TODO: object here
    ...
    public List<object>? ContainType
    {
        get;
        set;
    } // TODO: object here
    ...
    public List<string>? OpenedByKeyID
    {
        get;
        set;
    }
    ...
    public double? WeaponErgonomicPenalty
    {
        get;
        set;
    }
    ...
    public double? OperatingResource
    {
        get;
        set;
    }
    ...
    public XYZ? PostRecoilHorizontalRangeHandRotation
    {
        get;
        set;
    }
    ...
    public XYZ? PostRecoilVerticalRangeHandRotation
    {
        get;
        set;
    }
    ...
    public XYZ? ProgressRecoilAngleOnStable
    {
        get;
        set;
    }
    ...
    public double? RecoilCategoryMultiplierHandRotation
    {
        get;
        set;
    }
    ...
    public double? ChamberAmmoCount
    {
        get;
        set;
    }
    ...
    public double? ShotgunDispersion
    {
        get;
        set;
    }
    ...
    public XYZ? CameraToWeaponAngleSpeedRange
    {
        get;
        set;
    }
    ...
    public double? CameraToWeaponAngleStep
    {
        get;
        set;
    }
    ...
    public XYZ? TacticalReloadStiffnes
    {
        get;
        set;
    }
    ...
    public double? TacticalReloadFixation
    {
        get;
        set;
    }
    ...
    public XYZ? RotationCenterNoStock
    {
        get;
        set;
    }
    ...
    public List<ShotsGroupSettings>? ShotsGroupSettings
    {
        get;
        set;
    }
    ...
    public double? HipAccuracyRestorationDelay
    {
        get;
        set;
    }
    ...
    public double? HipAccuracyRestorationSpeed
    {
        get;
        set;
    }
    ...
    public double? HipInnaccuracyGain
    {
        get;
        set;
    }
    ...
    public double? BaseMalfunctionChance
    {
        get;
        set;
    }
    ...
    public double? DurabilityBurnRatio
    {
        get;
        set;
    }
    ...
    public double? CoolFactorGunMods
    {
        get;
        set;
    }
    ...
    public double? HeatFactorByShot
    {
        get;
        set;
    }
    ...
    public double? DoubleActionAccuracyPenalty
    {
        get;
        set;
    }
    ...
    public double? RecoilReturnPathDampingHandRotation
    {
        get;
        set;
    }
    ...
    public double? RecoilReturnPathOffsetHandRotation
    {
        get;
        set;
    }
    ...
    public double? RecoilReturnSpeedHandRotation
    {
        get;
        set;
    }
    ...
    public double? RecoilStableAngleIncreaseStep
    {
        get;
        set;
    }
    ...
    public double? RecoilStableIndexShot
    {
        get;
        set;
    }
    ...
    public double? MountCameraSnapMultiplier
    {
        get;
        set;
    }
    ...
    public double? MountHorizontalRecoilMultiplier
    {
        get;
        set;
    }
    ...
    public double? MountReturnSpeedHandMultiplier
    {
        get;
        set;
    }
    ...
    public double? MountVerticalRecoilMultiplier
    {
        get;
        set;
    }
    ...
    public double? MountingHorizontalOutOfBreathMultiplier
    {
        get;
        set;
    }
    ...
    public double? MountingVerticalOutOfBreathMultiplier
    {
        get;
        set;
    }
    ...
    public double? Indestructibility
    {
        get;
        set;
    }
    ...
    public double? BlindnessProtection
    {
        get;
        set;
    }
    ...
    public double? CompressorAttack
    {
        get;
        set;
    }
    ...
    public double? CompressorRelease
    {
        get;
        set;
    }
    ...
    public double? EQBand1Frequency
    {
        get;
        set;
    }
    ...
    public double? EQBand2Frequency
    {
        get;
        set;
    }
    ...
    public double? EQBand3Frequency
    {
        get;
        set;
    }
    ...
    public double? EffectsReturnsCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? EffectsReturnsGroupVolume
    {
        get;
        set;
    }
    ...
    public double? EffectsReturnsGrEnvCommonCompressorSendLeveloupVolume
    {
        get;
        set;
    }
    ...
    public double? EnvNatureCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? EnvTechnicalCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? GunsCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? HeadphonesMixerVolume
    {
        get;
        set;
    }
    ...
    public double? HighpassResonance
    {
        get;
        set;
    }
    ...
    public double? AmbientCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public double? ClientPlayerCompressorSendLevel
    {
        get;
        set;
    }
    ...
    public Dictionary<HealthFactor, EffectsHealthProps>? EffectsHealth
    {
        get;
        set;
    }
    ...
    [JsonConverter(typeof(ArrayToObjectFactoryConverter))]
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
    public Dictionary<DamageEffectType, EffectDamageProps>? EffectsDamage
    {
        get;
        set;
    }
    ...
    public double? KnifeHitSlashRate
    {
        get;
        set;
    }
    ...
    public double? KnifeHitStabRate
    {
        get;
        set;
    }
    ...
    public double? SecondryDistance
    {
        get;
        set;
    }
    ...
    public double? PrimaryConsumption
    {
        get;
        set;
    }
    ...
    public double? SecondryConsumption
    {
        get;
        set;
    }
    ...
    public double? DeflectionConsumption
    {
        get;
        set;
    }
    ...
    public XYZ? AppliedTrunkRotation
    {
        get;
        set;
    }
    ...
    public XYZ? AppliedHeadRotation
    {
        get;
        set;
    }
    ...
    public XYZ? ColliderScaleMultiplier
    {
        get;
        set;
    }
    ...
    public double? BulletDiameterMillimeters
    {
        get;
        set;
    }
    ...
    public double? PenetrationPowerDeviation
    {
        get;
        set;
    }
    ...
    public double? CasingEjectPower
    {
        get;
        set;
    }
    ...
    public double? PenetrationChanceObstacle
    {
        get;
        set;
    }
    ...
    public double? FragmentationChance
    {
        get;
        set;
    }
    ...
    public double? SpeedRetardation
    {
        get;
        set;
    }
    ...
    public double? StaminaBurnPerDamage
    {
        get;
        set;
    }
    ...
    public double? HeavyBleedingDelta
    {
        get;
        set;
    }
    ...
    public double? LightBleedingDelta
    {
        get;
        set;
    }
    ...
    public double? MaxExplosionDistance
    {
        get;
        set;
    }
    ...
    public string? AmmoTooltipClass
    {
        get;
        set;
    }
    ...
    public double? LightAndSoundShotSelfContusionTime
    {
        get;
        set;
    }
    ...
    public double? MalfMisfireChance
    {
        get;
        set;
    }
    ...
    public double? ContusionDistance
    {
        get;
        set;
    }
    ...
    public double? MinTimeToContactExplode
    {
        get;
        set;
    }
    ...
    public double? RecoilDampingHandRotation
    {
        get;
        set;
    }
    ...
    public List<RepairStrategyType>? RepairStrategyTypes
    {
        get;
        set;
    }
    ...
    public double? BallisticCoeficient
    {
        get;
        set;
    }
    ...
    public double? BulletDiameterMilimeters
    {
        get;
        set;
    }
    ...
    public double? ScavKillExpPenalty
    {
        get;
        set;
    }
    ...
    public double? ScavKillExpPenaltyPVE
    {
        get;
        set;
    }
    ...
    public double? ScavKillStandingPenalty
    {
        get;
        set;
    }
    ...
    public double? ScavKillStandingPenaltyPVE
    {
        get;
        set;
    }
    ...
    public double? TradersDiscountPVE
    {
        get;
        set;
    }
    ...
    public double? BipodCameraSnapMultiplier
    {
        get;
        set;
    }
    ...
    public double? BipodOutOfStaminaBreathMultiplier
    {
        get;
        set;
    }
    ...
    public double? BipodReturnHandSpeedMultiplier
    {
        get;
        set;
    }
    ...
    public XYZ? PitchLimitProneBipod
    {
        get;
        set;
    }
    ...
    public double? AdjustableOpticSensitivity
    {
        get;
        set;
    }
    ...
    public double? AdjustableOpticSensitivityMax
    {
        get;
        set;
    }
