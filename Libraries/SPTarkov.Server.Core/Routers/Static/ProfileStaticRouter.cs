            ...
            [
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.CreateProfile(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetProfileData(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.RegenerateScav(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        )
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.ChangeVoice(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.ChangeNickname(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.ValidateNickname(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetReservedNickname(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        )
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetProfileStatus(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        )
                ...
                new RouteAction(
                    "/client/profile/view",
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetOtherProfile(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetProfileSettings(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.SearchProfiles(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetMiniProfile(
                            url,
                ...
                new RouteAction(
                    "/launcher/profiles",
                    async (url, info, sessionID, output) =>
                        await profileCallbacks.GetAllMiniProfiles(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        )
