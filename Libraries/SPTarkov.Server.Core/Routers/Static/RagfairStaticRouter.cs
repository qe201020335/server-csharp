        ...
        : base(
            ...
            [
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await ragfairCallbacks.GetMarketPrice(
                            url,
                            info as GetMarketPriceRequestData,
                            sessionID
                        ),
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await ragfairCallbacks.StorePlayerOfferTaxAmount(
                            url,
                            info as StorePlayerOfferTaxAmountRequestData,
                            sessionID
                        ),
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await ragfairCallbacks.SendReport(
                            url,
                            info as SendRagfairReportRequestData,
                            sessionID
                        ),
                ...
                new RouteAction(
                    "/client/items/prices",
                    async (url, info, sessionID, output) =>
                        await ragfairCallbacks.GetFleaPrices(
                            url,
                ...
                new RouteAction(
                    ...
                    async (url, info, sessionID, output) =>
                        await ragfairCallbacks.GetFleaOfferById(
                            url,
                            info as GetRagfairOfferByIdRequest,
                            sessionID
                        ),
